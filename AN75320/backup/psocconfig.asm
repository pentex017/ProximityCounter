...
export LoadConfig_an75320
export _LoadConfig_an75320
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_an75320
	lcall	LoadConfigTBL_an75320_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration an75320
;
;    Load configuration registers for an75320.
...
_LoadConfig_an75320:
 LoadConfig_an75320:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_an75320_Bank0
    mov     X, <LoadConfigTBL_an75320_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_an75320_Bank1
    mov     X, <LoadConfigTBL_an75320_Bank1
